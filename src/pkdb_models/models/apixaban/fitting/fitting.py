...
def main() -> None:
    ...
    console.print(":wrench: FIT APIXABAN :wrench:")
    console.rule(style="white")
    ...
    if not options.output_dir:
        from pkdb_models.models.apixaban import RESULTS_PATH_FIT
    ...
    results: Dict[str, Tuple[OptimizationResult, OptimizationProblem]] = fit_apixaban(
        fit_experiments=fit_experiments,
