...
The model is distributed as [SBML](http://sbml.org) format available from [`apixaban_body_flat.xml`](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_body_flat.xml) with 
corresponding [SBML4humans model report](https://sbml4humans.de/model_url?url=https://raw.githubusercontent.com/matthiaskoenig/apixaban-model/main/models/apixaban_body_flat.xml) and [model equations](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_body_flat.md).
...
### Comp submodels
* **coagulation** submodel [`apixaban_coagulation.xml`](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_coagulation.xml) with [SBML4humans report](https://sbml4humans.de/model_url?url=https://raw.githubusercontent.com/matthiaskoenig/apixaban-model/main/models/apixaban_coagulation.xml) and [equations](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_coagulation.md).
* **liver** submodel [`apixaban_liver.xml`](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_liver.xml) with [SBML4humans report](https://sbml4humans.de/model_url?url=https://raw.githubusercontent.com/matthiaskoenig/apixaban-model/main/models/apixaban_liver.xml) and [equations](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_liver.md).
* **kidney** submodel [`apixaban_kidney.xml`](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_kidney.xml) with [SBML4humans report](https://sbml4humans.de/model_url?url=https://raw.githubusercontent.com/matthiaskoenig/apixaban-model/main/models/apixaban_kidney.xml) and [equations](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_kidney.md).
* **intestine** submodel [`apixaban_intestine.xml`](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_intestine.xml) with [SBML4humans report](https://sbml4humans.de/model_url?url=https://raw.githubusercontent.com/matthiaskoenig/apixaban-model/main/models/apixaban_intestine.xml) and [equations](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_intestine.md).
* **whole-body** submodel [`apixaban_body.xml`](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_body.xml) with [SBML4humans report](https://sbml4humans.de/model_url?url=https://raw.githubusercontent.com/matthiaskoenig/apixaban-model/main/models/apixaban_body.xml) and [equations](../../../../../../reproducibility_studies/apixaban-model/models/apixaban_body.md).
